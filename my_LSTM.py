# -*- coding: utf-8 -*-
"""
Created on Thu Nov  9 16:41:21 2023
...
'''
    ...
    iTransformer_checkpoint_202311101540.pth
    saved_params = model.load_state_dict(torch.load('.\\saved_models\\iTransformer_checkpoint_202311101540.pth'))
'''
